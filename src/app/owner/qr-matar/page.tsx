...
export default function DoctorMatarQrCodePage() {
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      ...
      url.searchParams.set('name', 'Dr.Mohammad Matar');
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-4">
      ...
      <Card className="w-full max-w-md shadow-2xl">
        <CardHeader>
          <CardTitle className="text-2xl">QR Code for Dr.Mohammad Matar</CardTitle>
          <CardDescription>
            Dr.Mohammad Matar can scan this QR code to log in to the doctor portal.
          </CardDescription>
        </CardHeader>
