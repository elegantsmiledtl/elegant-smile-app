...
export default function DoctorIbraheemQrCodePage() {
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      ...
      url.searchParams.set('name', 'Dr.Ibraheem Omar');
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-4">
      ...
      <Card className="w-full max-w-md shadow-2xl">
        <CardHeader>
          <CardTitle className="text-2xl">QR Code for Dr.Ibraheem Omar</CardTitle>
          <CardDescription>
            Dr.Ibraheem Omar can scan this QR code to log in to the doctor portal.
          </CardDescription>
        </CardHeader>
